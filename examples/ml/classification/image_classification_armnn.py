...
"""
This script performs image classification using the ArmNNInterpreter engine.
...
To run this script:
    $ python3 image_classification_armnn.py
...
image.show_image("ArmNN: Image Classification", output_image)
