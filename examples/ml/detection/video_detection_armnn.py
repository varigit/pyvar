...
"""
This script performs object detection on a video stream using the
ArmNNInterpreter engine.
...
6. Creates an overlay instance and draws the output image with the detection
   result and other information for each frame.
7. Shows the output video using the Multimedia helper.

Example:

To run this script:
    $ python3 video_detection_armnn.py
