...
.. literalinclude:: ../../../examples/ml/utils/variscite_ftp.py
   :language: python
   :linenos:
...
.. _variscite_ftp.py: https://github.com/varjig/pyvar/blob/master/examples/ml/utils/variscite_ftp.py
...
.. literalinclude:: ../../../examples/ml/utils/other_ftp.py
   :language: python
   :linenos:
   :caption: **Source code**: `other_ftp.py`_
   :name: Retrieve from Other FTP

.. _other_ftp.py: https://github.com/varjig/pyvar/blob/master/examples/ml/utils/other_ftp.py
...
.. literalinclude:: ../../../examples/ml/utils/calculate_time.py
   :language: python
   :linenos:
   :caption: **Source code**: `calculate_time.py`_
   :name: Calculate Time

.. _calculate_time.py: https://github.com/varjig/pyvar/blob/master/examples/ml/utils/calculate_time.py
